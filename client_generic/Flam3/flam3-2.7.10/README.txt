...
TBD: fixed interpolation bug when magnitude of rotation/scaling
    component of affine transform is 0.  removed secant variation in
    favor of 'fixed' secant2 (eliminates gap in y direction, scales
    y-coordinate by weight).
